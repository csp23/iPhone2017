...
//  myCalendar
//
//  Created by ououou on 2017/9/29.
...
int main(int argc, char *argv[])
{
    ...
    if (argc == 1) {
        ...
        NSDateComponents *dateComps = [ns_cal components:NSCalendarUnitYear|NSCalendarUnitMonth|
                                       NSCalendarUnitDay|NSCalendarUnitHour|NSCalendarUnitMinute fromDate:startDate];
        year = [dateComps year];
        month = [dateComps month];
        
        [cal printByMonth:month AndYear: year];
